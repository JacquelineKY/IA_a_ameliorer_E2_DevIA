...
#folder_path = 'C:\Users\ajyue\E2_Amelioration_d\'une_IA_Indexer\Documents_to_index'
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python index_folder.py <folder_path>, here:  python ingestion.py data ")
        sys.exit(1)
